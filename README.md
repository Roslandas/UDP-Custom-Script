...
1. Download and run the installation script:
    ```sh
    wget "https://raw.githubusercontent.com/Roslandas/UDP-Custom-Script/main/install.sh" -O install.sh && chmod +x install.sh && bash install.sh
    ```
...
- [Telegram Channel (Shay Studio Lab)](https://t.me/Asrolka)
- [GitHub (Roslandas)](https://github.com/Roslandas)
